...
class Define:
    ...
    TWSE_DAILY_PRICE_HEADERS = {
        ...
        "Accept-Language": "zh-TW,zh;q=0.9,en-US;q=0.8,en;q=0.7",
        "Connection": "keep-alive",
        "Cookie": "JSESSIONID=6C97DFC5F3EB824FDAA325CA3C2407E5; _ga=GA1.3.1157774665.1572671841; _gid=GA1.3.132873238.1572671841",
...
class MarketType:
    ...
    @staticmethod
    def get_id(type):
        if type == MarketType.TWSE:
            return MarketTypeId.TWSE
        else:
            return MarketTypeId.TPEX
